...
* Pass this *xs_element_t* structure of root element *food_root* as an argument to XML parser.
...
static const xs_element_t food_descendant[] =
{
    ...
    [1].Content.Facet.Decimal.MinValue = -3.40282e+38f,
    [1].Content.Facet.Decimal.MaxValue = 3.40282e+38f,
