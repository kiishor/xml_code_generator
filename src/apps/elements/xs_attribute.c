...
const xs_attribute_t attribute_Attr[TOTAL_ATTRIBUTE_ATTRIBUTES] =
{
  ...
  [EN_attribute_form].Name.String = "form",
  [EN_attribute_form].Name.Length = sizeof("form") - 1,
  [EN_attribute_form].Target.Type = EN_RELATIVE,
  [EN_attribute_form].Target.Offset = offsetof(attribute_t, attr.form),
  [EN_attribute_form].Content.Type = EN_STRING_DYNAMIC,
  [EN_attribute_form].Content.Facet.String.MinLength = DEFAULT_MIN_STRING_LENGTH,
  [EN_attribute_form].Content.Facet.String.MaxLength = DEFAULT_MAX_STRING_LENGTH,
  [EN_attribute_form].Use = EN_OPTIONAL,
};
