 ...
 *  ---------------------------- GLOBAL VARIABLES -----------------------------
 */
static const char* C_FILE_DESCRIPTION =
 "/**\n"
 "* @file\n"
 ...
 "* Pass this *xs_element_t* strcuture of root element *%s_root* as an argument to XML parser.\n\n"
 ...
 "* It contains *%s_t* strcuture based on the data structure of XML schema.\n"
...
static inline FILE* create_header_file(const char* const name)
{
  ...
  fprintf(header, H_FILE_DESCRIPTION, name);
...
static inline FILE* create_source_file(const char* const name)
{
  ...
  fprintf(source, C_FILE_DESCRIPTION, name);
