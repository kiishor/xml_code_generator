...
static const char* C_FILE_DESCRIPTION =
 ...
 "* Pass this *xs_element_t* structure of root element *%s_root* as an argument to XML parser.\n\n"
 ...
 "* It contains *%s_t* structure based on the data structure of XML schema.\n"
